...
```{r ensemble_caret, echo=FALSE, warning=FALSE}
...
The residual versus the predicted is show below, we have an increase ir decreas in resiudal futher in valuw we predict. 
