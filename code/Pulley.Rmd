...
In this section, we build an ensemble model, we use **caretEnsemble** to build the ensemble. We can notice that the prediction with two models **glm** and **random forest** is not accurate. We shall never go toward one or four. 
