...
predict_ensemble <- as.data.frame(predict(model_ensemble, newdata=ensemble_testing ))
...
predict_ensemble_2 <- as.data.frame(predict(stack_ensemble, newdata=ensemble_testing)) 
