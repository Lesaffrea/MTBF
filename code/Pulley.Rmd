...
The distribution of failure is from one to seventy seven per functional location, the low number have to be group per materail type and failure mode. 
