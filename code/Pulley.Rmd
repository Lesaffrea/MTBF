...
We have a prediction on numeric and therefore we recalibrate, the confusion is a sbelow, we certainly overfir in this case, but we show that we can have a pretty good prediction on class of time to failure. 
