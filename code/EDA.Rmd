...
We check now if we can enhanced the distribution using **bootstrap**, which will give use a family of of devices **mtbf**, the bootstrap is dome with 500 samples, in this case we can wonder about the zero occurrence.
